...
def vggvox_resnet2d_icassp(
    ...
    net = args.SERVE["NET"]
    loss = args.SERVE["LOSS"]
    vlad_clusters = args.SERVE["VLAD_CLUSTER"]
    ghost_clusters = args.SERVE["GHOST_CLUSTER"]
    bottleneck_dim = args.SERVE["BOTTLENECK_DIM"]
    aggregation = args.SERVE["AGGREGATION_MODE"]
