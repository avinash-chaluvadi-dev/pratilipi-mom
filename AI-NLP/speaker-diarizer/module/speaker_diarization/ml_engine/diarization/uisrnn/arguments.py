...
def parse_arguments():
    ...
    model_parser.add_argument(
        "--rnn_depth", default=1, type=int, help="The number of RNN layers."
    )
    model_parser.add_argument(
        "--rnn_dropout",
        default=0.2,
    ...
    training_parser.add_argument(
        "--batch_size", "-b", default=10, type=int, help="The batch size for training."
    )
    training_parser.add_argument(
        "--num_permutations",
        default=10,
    ...
    training_parser.add_argument(
        "--grad_max_norm", default=5.0, type=float, help="Max norm of the gradient."
    )
    training_parser.add_argument(
