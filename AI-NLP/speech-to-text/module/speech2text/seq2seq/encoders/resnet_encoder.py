    ...
    def _encode(self, input_dict):
        ...
        if "resnet_size" in self.params:
            ...
            if "bottleneck" not in self.params:
                raise ValueError(
                    'If "resnet_size" not specified you have to provide '
