...
from module.speech2text.seq2seq.parts.cnns.conv_blocks import conv_actv, conv_bn_actv
...
def conv_1x1(
    layer_type, name, inputs, filters, strides, regularizer, training, data_format
):
    """
...
class WavenetEncoder(Encoder):
    ...
    def get_optional_params():
        return dict(
            ...
            **{"data_format": str, "bn_momentum": float, "bn_epsilon": float}
        )
    ...
    def _encode(self, input_dict):
        ...
        if training:
            ...
            source, src_length, condition, spec_length, spec_offset = input_dict[
                "source_tensors"
            ]
        ...
        if local_conditioning:
            ...
            if training:
                ...
                zeros = tf.saturate_cast(
                    tf.zeros([condition_shape[0], receptive_field, filters]), dtype
                )
