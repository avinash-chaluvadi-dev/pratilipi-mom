...
from module.speech2text.seq2seq.parts.transformer.utils import get_padding_bias, get_padding
from module.speech2text.seq2seq.parts.convs2s import ffn_wn_layer, conv_wn_layer
...
class ConvS2SEncoder(Encoder):
    ...
    def _call(self, encoder_inputs, padding_mask):
        ...
        with tf.variable_scope("linear_layer_after_cnn_layers"):
            ...
            scale = 1.0 / (2.0 * self.params.get("att_layer_num", 1))
