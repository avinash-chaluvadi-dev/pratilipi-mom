...
class UnidirectionalRNNEncoderWithEmbedding(Encoder):
    ...
    def __init__(self, params, model, name="unidir_rnn_encoder_with_emb", mode="train"):
...
class BidirectionalRNNEncoderWithEmbedding(Encoder):
    ...
    def __init__(self, params, model, name="bidir_rnn_encoder_with_emb", mode="train"):
...
class GNMTLikeEncoderWithEmbedding(Encoder):
    ...
    def __init__(self, params, model, name="gnmt_encoder_with_emb", mode="train"):
        """Encodes data into representation.
...
class GNMTLikeEncoderWithEmbedding_cuDNN(Encoder):
    ...
    def __init__(self, params, model, name="gnmt_encoder_with_emb_cudnn", mode="train"):
        """Encodes data into representation
    ...
    def _encode(self, input_dict):
        ...
        return {
            "outputs": tf.transpose(layer_input, perm=[1, 0, 2]),
            "state": None,
            "src_lengths": source_length,
            "encoder_input": source_sequence,
        }
