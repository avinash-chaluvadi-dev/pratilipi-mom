...
from module.speech2text.seq2seq.encoders import Encoder
from module.speech2text.seq2seq.parts.transformer import attention_layer, ffn_layer, utils, embedding_layer
    ...
    def _encode(self, input_dict):
        ...
        with tf.name_scope("encode"):
            ...
            with tf.name_scope("add_pos_encoding"):
                ...
                encoder_inputs = embedded_inputs + tf.cast(
                    x=pos_encoding, dtype=embedded_inputs.dtype
                )
