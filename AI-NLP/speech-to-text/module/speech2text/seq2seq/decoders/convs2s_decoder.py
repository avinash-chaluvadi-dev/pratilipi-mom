...
from module.speech2text.seq2seq.parts.transformer import beam_search

from module.speech2text.seq2seq.parts.transformer import embedding_layer
from module.speech2text.seq2seq.parts.transformer.utils import get_padding

from module.speech2text.seq2seq.parts.convs2s import ffn_wn_layer, conv_wn_layer, attention_wn_layer
from module.speech2text.seq2seq.parts.convs2s.utils import gated_linear_units
...
class ConvS2SDecoder(Decoder):
        ...
        with tf.name_scope("decode"):
            ...
            if len(self.layers) == 0:
                ...
                with tf.variable_scope("embedding"):
                    if (
                        "embedding_softmax_layer" in input_dict["encoder_output"]
                ...
                if self.params.get("pos_embed", True):
                    with tf.variable_scope("pos_embedding"):
                        if (
                            "position_embedding_layer" in input_dict["encoder_output"]
                            and self.params["shared_embed"]
                        ):
                            self.position_embedding_layer = input_dict[
                                "encoder_output"
    ...
    def _call(
        self, decoder_inputs, encoder_outputs_a, encoder_outputs_b, input_attention_bias
    ):
    ...
    def predict(self, encoder_outputs, encoder_outputs_b, inputs_attention_bias):
        ...
        logits = self.decode_pass(
            top_decoded_ids, encoder_outputs, encoder_outputs_b, inputs_attention_bias
        )
