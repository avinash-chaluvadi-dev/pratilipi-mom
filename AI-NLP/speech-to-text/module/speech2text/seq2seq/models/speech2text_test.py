...
from module.speech2text.utils.funcs import train, evaluate, infer
from module.speech2text.utils.utils_tools import get_available_gpus
...
class Speech2TextModelTests(tf.test.TestCase):
    ...
    def convergence_test(
        self, train_loss_threshold, eval_loss_threshold, eval_wer_threshold
    ):
    ...
    def finetuning_test(
        ...
        for dtype in [tf.float32, "mixed"]:
            ...
            loss_ft, eval_loss_ft, eval_dict_ft = self.run_model(
    ...
    def infer_test(self):
        ...
        with tf.Graph().as_default():
            ...
            true_csv = pd.read_csv(
                "seq2seq/test_utils/toy_speech_data/toy_data.csv",
            )
    ...
    def maybe_functions_test(self):
        ...
        inp_dict = {
            "source_tensors": [input_values[0][0], input_values[0][1]],
