...
from module.speech2text.seq2seq.models.model import Model
...
class EncoderDecoderModel(Model):
    ...
    def __init__(self, params, mode="train", hvd=None, json_data=None):
        ...
        * **loss_params** (dict) --- dictionary with loss configuration. For
        ...
        super(EncoderDecoderModel, self).__init__(
            params=params, mode=mode, hvd=hvd, json_data=json_data
        )
