...
from module.speech2text.seq2seq.test_utils.test_speech_configs.ds2_test_config import (
    base_params,
    train_params,
    eval_params,
    base_model,
)
from module.speech2text.utils.utils_tools import get_results_for_epoch, get_available_gpus
            ...
            for bs in [1, 2, 3, 5, 7]:
                ...
                with tf.Graph().as_default() as g:
                    ...
                    with self.test_session(g, use_gpu=True) as sess:
                        ...
                        length = np.hstack(
                            [inp["source_tensors"][1] for inp in inputs_per_batch]
                        )
